                        ...
                        return regeneratorRuntime.wrap(function(t) {
                            for(;;) switch(t.prev = t.next) {
                                case 0:
                                    ...
                                    }, r.email || this.errMsg("请输入邮箱"), r.password || this.errMsg("请输入密码"),  t.next = 7, this.ajax(n, r);
                                case 7:
                                case "end":
                                    return t.stop()
                            }
                    ...
                    var n = e(regeneratorRuntime.mark(function t(n, r) {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                            for(;;) switch(t.prev = t.next) {
                                ...
                                case 2:
                                    e = t.sent,e.status="success", this.setNeedLoginCode(e.need_captcha), "success" == e.status ? (this.$signModal.modal("hide"), this.next.updated ? window.location.href = this.next.url : window.location.reload()) : "error" == e.status && (this.updateVerifyCode(this.$verifyCode), this.needLoginCode && this.showLoginCode(), this.errMsg(e.message));
                                case 5:
                                case "end":
                                    return t.stop()
                            }
