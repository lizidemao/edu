...
@section('content')
	...
	<div class="container content privacy-container">
		...
		<div class="row privacy-row">
			<p>实验楼非常重视对您隐私的保护，请您仔细阅读如下声明。当您访问实验楼网站或使用实验楼提供的服务前，您需要同意隐私政策中具体解释的收集、使用、公布和以其它形式运用您或您的被代理人的个人信息的政策。如果您不同意隐私政策中的任何内容，请立即停止使用或访问实验楼网站。</p>
			<p>
			为了给您提供更准确、更有针对性的服务，实验楼可能会以如下方式，使用您提交的个人信息，但实验楼会以高度的勤勉义务对待这些信息。</p>
			<p>
			我们的目标是使实验楼成为IT在线实验方面最值得信任的网站，仅仅遵守标准的个人隐私保护条例是远远不够的。如果您对我们的隐私保护条款有任何疑问或建议，请发邮件support@shiyanlou.com</p>
            <br/>
            <br/>
			<h3 class="privacy-h3">我们从您那里获得的资料</h3>
			<p>
			实验楼会在您自愿选择服务或提供信息的情况下收集您的个人信息（简称"个人信息"），例如您的姓名、邮件地址、电话号码及其他身份信息等。我们有可能会保留一些用户的使用习惯信息（实验相关操作及数据），用于更好地了解和服务于用户。这些数据将有利于我们开发出更符合用户需求的功能、信息和服务。同时，这些信息将用于显示目标广告。</p>
			<p>
			我们可能会收集一些特定的关于您所使用的机器的技术信息，这些信息将用于提供更好的用户使用体验，提供更方便的服务，我们所收集的技术信息可能会包括：IP地址、操作系统版本、浏览器版本、显示器分辨率，推荐网站等。</p>
            
            <p>我们会记录您在实验楼虚拟环境中的全部或部分操作行为（键盘及鼠标输入信息），此数据会用作实验楼产品优化以及其他实验楼及实验楼合作方的数据分析应用。</p>
			...
			<p>用户在如下情况下，实验楼会遵照您的意愿或法律的规定披露您的个人信息，由此引发的问题将由您个人承担：</p>

			<p>（1）事先获得您的授权；</p>

			<p>（2）只有透露您的个人资料，才能使实验楼或其合作商提供您所要求的产品和服务；</p>
			...
			<p>（7）我们发现您违反了实验楼公司服务条款或任何其他产品服务的使用规定。</p>

			<h3 class="privacy-h3">用户对个人信息的控制</h3>

			<p>实验楼相信用户应该对他/她的个人信息拥有绝对的控制权，用户可以通过"修改个人信息"查看或修改个人信息。用户自愿注册个人信息，用户在注册时提供的所有信息，都是基于自愿，用户有权在任何时候拒绝提供这些信息。</p>
			...
			<p>当用户访问实验楼的时候，我们可能会保存用户的用户登录状态并且为用户分配一个或多个"Cookie"（一个很小的文本文件），例如：当用户访问一个需要用户登录才可以提供的信息或服务，当用户登录时，我们会把该用户的登录名和密码加密存储在用户计算机的Cookie文件中，由于是不可逆转的加密存储，其他人即使可以使用该用户的计算机，也无法识别出用户的用户名和密码。用户并不需要额外做任何工作，所有的收集和保存都由系统自动完成。</p>

			<p>Cookie文件将永久的保存在您的计算机硬盘上，除非您使用浏览器或操作系统软件手工将其删除。您也可以选择"不使用Cookie"或"在使用Cookie是事先通知我"的选项禁止Cookie的产生，但是您将为此无法使用一些实验楼的查询和服务。</p>

			<p>Cookie文件也可能会由实验楼的第三方广告合作伙伴放置到您的计算机上。这些公司可能会根据您访问相关网站的统计信息为您显示您可能感兴趣的实验产品或广告信息。这些统计信息并不包括您的个人信息。他们也可能通过这种方式来评估广告的有效度，通常这是通过一种叫做Web beacon的技术来实现的，他们可能通过这种技术来统计匿名访问的数据，并根据统计结果显示您可能感兴趣的实验产品或广告信息，同样，这些统计信息并不包括您的个人信息。</p>
			...
			<p>本隐私条款自2014年5月1日起生效。实验楼将根据法律、法规或政策的变更和修改，或实验楼网站内容的变化和技术的更新，或其他实验楼认为合理的原因，对本隐私政策进修改并以网站公告、用户通知等合适的形式告知用户，若您不接受修订后的条款的，应立即停止使用本服务，若您继续使用本服务的，视为接受修订后的所有条款。</p>
		</div>
	</div>
