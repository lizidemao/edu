            ...
            <div class="row">
                <div class="col-md-7">
                    <a class="container-title">
                        <img src="/home/img/container-title-2.png" />
                    </a>
                    <div style="margin-top:24px;">
                        <a id="course-btn" class="course-btn btn btn-lg" href="/courses">进入课程</a>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="introduce-unit col-sm-6 col-md-3">
                <div><a class="introduce-img"><img src="/home/img/introduceContainer1.gif" /></a></div>
                <div><span class="introduce-span">丰富全面的计算机实验课程</span></div>
            </div>
            <div class="introduce-unit col-sm-6 col-md-3">
                <div><a class="introduce-img"><img src="/home/img/introduceContainer2.gif" /></a></div>
                <div><span class="introduce-span">在线编程环境，1秒启动</span></div>
            </div>
            <div class="introduce-unit col-sm-6 col-md-3">
                <div><a class="introduce-img"><img src="/home/img/introduceContainer3.gif" /></a></div>
                <div><span class="introduce-span">每天一个项目课，丰富你的项目经验</span></div>
            </div>
            <div class="introduce-unit col-sm-6 col-md-3">
                <div><a class="introduce-img"><img src="/home/img/introduceContainer4.gif" /></a></div>
			...
			<div class="tab-pane clearfix active" id="study-line">
					...
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513730333.png">
                            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513769430.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513793360.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513926288.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513867033.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514004752.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514111981.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514095761.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514153000.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514037180.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471513817808.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="paths/show.html">
                        <div class="path-item">
                            <div class="col-xs-5 col-sm-4 path-img">
                                <img src="/home/img/1471514058548.png">
                            </div>
                            <div class="col-xs-7 col-sm-8">
...
<div class="col-md-3 col-sm-6  course">
    <a class="course-box" href="courses/show.html">
        ...
        <div class="course-img">
            ...
            <img alt="Linux 基础入门（新版）" src="/home/img/ncn1.jpg">
...
<div class="col-md-3 col-sm-6  course">
    <a class="course-box" href="courses/show.html">
        ...
        <div class="course-img">
            ...
            <img alt="Go语言编程" src="/home/img/ncn11.jpg">
...
<div class="col-md-3 col-sm-6  course">
    <a class="course-box" href="courses/show.html">
        ...
        <div class="course-img">
            ...
            <img alt="PHP编程语言" src="/home/img/ncn23.jpg">
...
<div class="col-md-3 col-sm-6  course">
    <a class="course-box" href="courses/show.html">
        ...
        <div class="course-img">
            ...
            <img alt="Python Django Web框架" src="/home/img/ncn30.jpg">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="signin-form">
                        <form action="/login" method="post">
                            ...
                            <div class="form-group">
                                <input class="btn btn-primary"  type="submit" value="进入实验楼">
                            </div>
